...
//     } catch (err) {
//       console.error(err);
//       toast.error("Failed to fetch average interaction time");
//     } finally {
//       setAvgLoading(false);
//     }
//   }
...
//     } catch (err) {
//       console.error(err);
//       toast.error("Failed to fetch chat status data");
//     } finally {
...
//     } catch (err) {
//       console.error(err);
//       toast.error("Failed to load chat status details");
//     }
//   };
...
//     } catch (err) {
//       console.error(err);
//       toast.error("Failed to load E-Bill details");
//     }
//   };
...
//       } catch (err) {
//         console.error(err);
//         toast.error("Failed to fetch pay bill stats");
//       } finally {
...
//       } catch (err) {
//         console.error(err);
//         toast.error("Failed to fetch e-bill stats");
//       } finally {
...
//       } catch (err) {
//         console.error(err);
//         toast.error("Failed to fetch duplicate bill stats");
//       } finally {
...
//           <StatsCard
//             icon={<Zap />}
//             label="No Supply Complaint Registered"
...
//           <StatsCard
//             icon={<Wallet />}
//             label="Payment Initiation Menu Selection"
...
//           <StatsCard
//             icon={<Wallet />}
//             label="Duplicate Bill Requested"
...
// =========>>>>>>>above code is for the old dashboar page which have dashboard api handale API and log model used comman>>>>>>
