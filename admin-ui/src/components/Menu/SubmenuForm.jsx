          ...
          >
            ...
            >
              <div className="flex flex-col w-full">
                ...
                <div className="mt-3">
                  <label className="block text-sm font-medium text-gray-700 mb-1 flex items-center gap-1">
                    <ImageIcon className="w-4 h-4" /> Submenu Icon ( PNG, JPG, JPEG, SVG )
                  </label>
                  ...
                  <input
                    ...
                    onChange={async (e) => {
                      ...
                      // If SVG → read text & inspect for XSS
                      if (ext === "svg") {
                        try {
                          ...
                          const badPatterns = [
                            /<script[\s\S]*?>/gi,
                            /\bon\w+=/gi,                // onclick, onload, onerror etc.
                            /javascript:/gi,
                          ...
                          toast.error("Cannot scan SVG! Blocked for safety.");
                          e.target.value = "";
                          return;
                        }
                      }
